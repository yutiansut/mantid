 ...
 *  @param newAxis :: A Unique_ptr to the new axis. The class will take ownership.
 ...
 */
void MatrixWorkspace::pythonReplaceAxis(const std::size_t &axisIndex, Axis *newAxis) {
